...
<body>
    ...
    <?php
            ...
            $result = Database::get_timesheet($_SESSION['id']);
        ...
        <div class=\"col-12 col-md-12\">
            <center>
            <h3 style = \"font-family: calibri;\">" . $_SESSION['name'] . "'s Timesheet <b><i class=\"fas fa-table\"></i></b></h3>
            </center>
        </div>
    </div>
    ...
    if(isset($_POST['submit'])){
        ...
        if(((float)$sun > 24) || ((float)$mon > 24) || ((float)$tues > 24) || ((float)$wed > 24) || ((float)$thurs > 24) || ((float)$fri > 24) || ((float)$sat > 24) ){
            ...
            if(Database::update_timesheet($_SESSION['id'], $sun, $mon, $tues, $wed, $thurs, $fri, $sat)){
            ...
            <table class=\"table\">
                ...
                <tbody>
                    <tr>
                        ...
                        <form method = \"post\">
                            <th scope=\"row\"><center>" . $_SESSION['name'] . "</center></th>
